...
Meißner P (2016). *rtext*. R package version 0.1.17.90000, &lt;URL: <https://github.com/petermeissner/rtext>&gt;.
...
<code style="white-space:normal;"> @Manual{Meissner2016, title = {rtext}, author = {Peter Meißner}, year = {2016}, note = {R package version 0.1.17.90000}, url = {<https://github.com/petermeissner/rtext>}, }
